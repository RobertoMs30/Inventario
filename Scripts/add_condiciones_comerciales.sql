-- ============================================================
--  MIGRACIÓN: Campo condiciones_comerciales en cotizaciones
--  Ejecutar en: TU_BASE_DE_DATOS
-- ============================================================

-- ── 1) Nueva columna en inventario.cotizaciones ────────────────

IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('inventario.cotizaciones') AND name = 'condiciones_comerciales')
BEGIN
    ALTER TABLE inventario.cotizaciones ADD condiciones_comerciales NVARCHAR(MAX) NULL;
    PRINT 'Columna condiciones_comerciales agregada.';
END
ELSE
    PRINT 'Columna condiciones_comerciales ya existe.';
GO

-- ── 2) Actualizar sp_CrearCotizacion ────────────────────────
...
-- ── 3) Actualizar sp_ActualizarCotizacion ───────────────────
...
-- ── 4) Actualizar sp_ObtenerCotizacionDetalle ───────────────
...
BEGIN
    ...
    SELECT id, folio, fecha, cliente, proyecto, fecha_reg,
           ...
           ISNULL(condiciones_comerciales, '')   AS condiciones_comerciales
...
PRINT '';
PRINT '====================================================';
PRINT ' Migración condiciones_comerciales completada.';
PRINT '====================================================';
